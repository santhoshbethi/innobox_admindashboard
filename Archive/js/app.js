...
$(document).ready(function () {
    ...
    var navbarCollapse = function () {
        if ($("#mainNav").offset().top > 50) {
            ...
            $("#dropdown-menu-id").css("margin-top", "10px");
            $("#mainNav").addClass("navbar-shrink-box-shadow");
        } else {
            $("#mainNav").removeClass("navbar-shrink");
            $("#dropdown-menu-id").css("margin-top", "32px");
            $("#mainNav").removeClass("navbar-shrink-box-shadow");
        }
    };
    ...
    $(".why-box").hover(function () {
        var imgsrc = $(this).children().find('img').attr("data-img");
        $(this).children().find('img').attr('src', imgsrc);
    }, function () {
        var hoverimgsrc = $(this).children().find('img').attr("data-img1");
        $(this).children().find('img').attr('src', hoverimgsrc);
    });

    // paralax - effect
    $('.innobox-easysec').parallax({ src: 'img/easytouse.jpg' });
    //$('.internal-headersec').parallax({src: 'img/internalbg.jpg'});
    ...
    $('.inner-networkstack').parallax({ src: 'img/network-stack-fnl.jpg' });
    $('.inner-connectivity').parallax({ src: 'img/networking-fnl.jpg' });
    $('.inner-portable-devices').parallax({ src: 'img/portable-fnl.jpg' });
    $('.inner-linux').parallax({ src: 'img/serviece-linux-image.jpg' });
    $('.inner-testing').parallax({ src: 'img/testing-fnl.jpg' });
    $('.inner-wireless').parallax({ src: 'img/service-wireless.jpg' });
    $('.inner-ai').parallax({ src: 'img/service-ai.jpg' });
    $('.inner-certification').parallax({ src: 'img/certification-serviece-image.jpg' });
    $('.inner-computer').parallax({ src: 'img/service-computer.jpg' });
    $('.inner-content').parallax({ src: 'img/service-content.jpg' });
    $('.inner-digital').parallax({ src: 'img/service-digital.jpg' });
    $('.inner-mobility').parallax({ src: 'img/service-mobility.jpg' });
    $('.inner-mobile').parallax({ src: 'img/932-1-mobile.jpg' });
    // 

    // customer say slider - start
    (function ($) {
        "use strict";
        // Auto-scroll
        ...
        // On carousel scroll
        $("#customerCarousel").on("slide.bs.carousel", function (e) {
    ...
    $(".addcountry-home").validate({
        ...
        submitHandler: function (form) {
            var contact_details = $("form.addcountry-home").serializeArray();
            // console.log(contact_details);
            // //

            $.ajax({
                type: 'POST',
                url: './mail/careers_send_mail.php',
    ...
    $(".addcountry1").validate({
        ...
        submitHandler: function (form) {
            // var contact_details = $("form.addcountry1").serializeArray();
            // //

            // $.ajax({
            //     type: 'POST',
            //     url: './mail/careers_mail.php',
            //     data: contact_details,
    ...
    $(".addcountry2").validate({
        ...
        messages: {
            name: {
                required: "Please enter a  Name",
                namespace: "Please enter valid  Name"
            },
            email: {
                required: "Please enter a  email",
                messagecheck: "Please enter valid email"
        ...
        submitHandler: function (form) {
            // var contact_details = $("form.addcountry2").serializeArray();
            // //
    ...
    $(".addcountry4").validate({
        ...
        messages: {
            ...
            job2: {
                required: "Please select a job Name",
                valueNotEquals: "Please select a job Name"
            },
            messagecheck: {
                required: "Please enter a  Name",
                messagecheck: "Please enter valid country Name"
        ...
        submitHandler: function (form) {
            var contact_details = $("form.addcountry4").serializeArray();
            //     //

            $.ajax({
                type: 'POST',
                url: './mail/contactform_mail.php',
                data: contact_details,
                success: function (msg) {
                    $('input.form-control').val("");
                    $('textarea.form-control').val("");
    ...
    $(".addcountry5").validate({
        ...
        submitHandler: function (form) {
            //     var contact_details = $("form.addcountry5").serializeArray();
            //     //
    ...
    $(".addcountry3").validate({
        ...
        submitHandler: function (form) {
            // var contact_details = $("form.addcountry3").serializeArray();
            // //
    ...
    $(".addcountry-career").validate({
        ...
        messages: {
            ...
            company: {
                ...
                messagecheck: "Please enter valid Company Name"
            },
        },
        submitHandler: function (form) {
            // var contact_details = $("form.addcountry-career").serializeArray();
            // //

            // console.log(contact_details);
            // $.ajax({
            //     type: 'POST',
            //     url: './mail/job_application_email.php',
            //     data: contact_details,
            //     success: function (data) {
            //         $('input.form-control').val("");
            //         $('textarea.form-control').val("");
    ...
    //     },
    //     submitHandler: function (form) {
    //         // var contact_details = $("form.innoboxcontact-form1").serializeArray();
    ...
    $(".addcountry-contact").validate({
        ...
        submitHandler: function (form) {
            var contact_details = $("form.addcountry-contact").serializeArray();
            //
    ...
    $(".addcountry6").validate({
        ...
        submitHandler: function (form) {
            var contact_details = $("form.addcountry6").serializeArray();
            //

            $.ajax({
                type: 'POST',
                url: './mail/latestworks_mail.php',
                data: contact_details,
                success: function (data) {
                    $('input.form-control').val("");
                    $('textarea.form-control').val("");
                    $('#myModalsevices').modal('hide');
                    $('#formsucess').modal('show');
...
$(document).ready(function (e) {
    $("#submitformtest").on('submit', function (e) {
        e.preventDefault();
        ...
        var qulification = $('#company1').val();
        var message = $('#message1').val();
        console.log(name.length)

        if (!mobilenumber && !name && !email && !qulification && !message) {
        ...
        else
        {
            ...
            if (name != '' && name.length > 3) {
                if (qulification != '' && qulification.length > 1) {
                    if (/^\d{10}$/.test(mobilenumber) && mobilenumber != '') {
...
$(document).ready(function (e) {
    $("#submitformtest1").on('submit', function (e) {
        var data = new FormData(this);
        var mobilenumber = $('#mobilenumber2').val();
        var name = $('#name2').val();
        var email = $('#email2').val();
        var qulification = $('#company2').val();
...
$(document).ready(function (e) {
    $("#submitformtest2").on('submit', function (e) {
        var data = new FormData(this);
        var mobilenumber = $('#mobilenumber3').val();
        var name = $('#name3').val();
        var email = $('#email3').val();
        var qulification = $('#company3').val();
...
$(document).ready(function (e) {
    $("#submitformtest3").on('submit', function (e) {
        var data = new FormData(this);
        var mobilenumber = $('#mobilenumber4').val();
        var name = $('#name4').val();
        var email = $('#email4').val();
        var qulification = $('#company4').val();
...
$(document).ready(function (e) {
    $("#submitformtest4").on('submit', function (e) {
        var data = new FormData(this);
        var mobilenumber = $('#mobilenumber5').val();
        var name = $('#name5').val();
        var email = $('#email5').val();
        var qulification = $('#company5').val();
...
$(document).ready(function (e) {
    $("#submitformtest5").on('submit', function (e) {
        var data = new FormData(this);
        var mobilenumber = $('#mobilenumber6').val();
        var name = $('#name6').val();
        var email = $('#email6').val();
        var qulification = $('#company6').val();
...
$(document).ready(function (e) {
    $("#openposition").on('submit', function (e) {
        var data = new FormData(this);
        var mobilenumber = $('#phone7').val();
        var name = $('#name7').val();
        var email = $('#email7').val();
        var previouscompany = $('#company7').val();

        var job = $('#select7 :selected').val();

        console.log(job);
        if (!mobilenumber && !name && !email && !previouscompany && !job) {
        ...
        else
        {
            ...
            if (name != '' && name.length > 3) {
                if (previouscompany != '' && previouscompany.length > 3) {
                    if (/^\d{10}$/.test(mobilenumber) && mobilenumber != '') {
                        if (job != '') {
                            var email = email;
                            if (validateEmail(email)) {
        ...
        // if (mobilenumber != '' && name != '' && email != '' && previouscompany != '' && job != '' && job != "-Select Job type-") {
...
// $(document).ready(function (e) {
//     $("#openposition").on('click', function (e) {
//         var data = new FormData(this);
//         var mobilenumber = $('#phone7').val();
//         var name = $('#name7').val();
//         var email = $('#email7').val();
...
$(document).ready(function () {
    ...
    $('ul.nav-tabs.whyus-tabs li a').click(function (e) {
      $('ul.nav-tabs.whyus-tabs li.active').removeClass('active')
