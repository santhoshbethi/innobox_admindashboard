<?php
    ...
    // {
    //     return '<label>Name : </label><strong>'.$data['name'].'</strong><br><label>Email : </label><strong>'.$data['email'].'</strong><br><label>Mobile Number : </label><strong>'.$data['mobilenumber'].'</strong><br><label>PreviousCompany : </label><strong>'.$data['company'].'</strong><br><label>Selected Job : </label><strong>'.$data['job1'].'</strong>';
    // }  
...
if(!empty($data1) || !empty($_FILES))
{
    ...
    function Sampleemail($data1)
    {
        ...
        <body>
        <label>Name : </label><strong>'.$data1['name'].'</strong><br><label>Email : </label><strong>'.$data1['email'].'</strong><br><label>Mobile Number : </label><strong>'.$data1['mobilenumber'].'</strong><br><label>PreviousCompany : </label><strong>'.$data1['company'].'</strong><br><label>Selected Job : </label><strong>'.$data1['job1'].'</strong><br><label>Page name : </label><strong>'.$data1['pagename'].'</strong>;
        </body>
        </html>';
    }  
